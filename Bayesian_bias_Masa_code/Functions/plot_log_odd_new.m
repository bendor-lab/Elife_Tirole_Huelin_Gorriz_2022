function [ROC,log_odd,AUC_combined,AUC_session,Mean_zdata,SE_zdata,pval_average,pval_session] = plot_log_odd_new(ROC,log_odd,place_cell_type,timebin,posbin,option,figure_option,save_option)
...
if strcmp(figure_option,'Y')
    ...
    figure(nfig)
    fig = figure(nfig)
    fig.Position = [600 100 1400 1000];
    colour_line= {'k','b','r','g'};
%     Legend = {'PRE','RUN','POST'};
end
        ...
        if strcmp(figure_option,'Y')
            ...
            elseif timebin == 1
                ...
                elseif strcmp(option,'rate fixed')
                    ...
                    % Because Perfcurve function fails to give right y when all log odd is zero.
