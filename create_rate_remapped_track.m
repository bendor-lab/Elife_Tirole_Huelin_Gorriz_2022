...
for track_id=1:number_of_rate_remapped_tracks
    ...
    place_fields_RATE_REMAPPED.track(track_id).x_bin_centres=place_fields.track(1).x_bin_centres;
    place_fields_RATE_REMAPPED.track(track_id).x_bin_edges=place_fields.track(1).x_bin_edges;
    place_fields_RATE_REMAPPED.track(track_id).x_bins_width=place_fields.track(1).x_bins_width;
