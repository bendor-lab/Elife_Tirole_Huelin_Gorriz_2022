    ...
    for this_folder=1:length(folders)
      ...
      switch option
                ...
                for this_track=1:length(sorted_replay)
                    ...
                    evt_times_to_remove= sorted_replay(this_track).cumulative_event_time.(epoch)< sleep_time_edges(this_time_win,1) |...
                                        sorted_replay(this_track).cumulative_event_time.(epoch)>= sleep_time_edges(this_time_win,2);
